...
public class HistogramEQ {
    ...
    private static BufferedImage readImage(String input) throws IOException {
        File original_f = new File(input+".jpg");
        BufferedImage original = ImageIO.read(original_f);
        return original;
    }

    private static void writeImage(String output, BufferedImage equalized) throws IOException {
